...
if __name__ == '__main__':
    ...
    parser.add_argument('--event', type=str,
                       help='Generate single event (carousing, fight, stealth, etc.)')
    ...
    if args.list:
        ...
        EventSoundscapeGenerator.generate_event(
